...
public class FormBeanPublic2 {
    ...
    public FormBeanPublic2(String inputName, Number selectName, List multi, boolean chk) {
    ...
    public boolean equals(Object obj) {
        ...
        final FormBeanPublic2 other = (FormBeanPublic2) obj;
    ...
    public String toString() {
        return "FormBeanPublic2{" + "inputName=" + inputName + ", selectName=" + selectName + ", multi=" + multi + ", chk=" + chk + '}';
    }
}
